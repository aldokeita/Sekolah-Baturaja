...
values
  ...
  ('a1fa7a10-0000-0000-0000-000000000301', 'AFMLOCAL-ANAK-C01', 'Santri Demo C1', 'Anak', 'Aktif', null),
  ('a1fa7a10-0000-0000-0000-000000000302', 'AFMLOCAL-ANAK-C02', 'Santri Demo C2', 'Anak', 'Aktif', null),
  ('a1fa7a10-0000-0000-0000-000000000303', 'AFMLOCAL-ANAK-C03', 'Santri Demo C3', 'Anak', 'Aktif', null)
on conflict (id) do nothing;
...
values
  ...
  ('a1fa7a10-0000-0000-0000-000000000301', 'AFMLOCAL-ANAK-C01', 'AFMLOCAL-ANAK-C01', 'santri+a1fa7a10-0000-0000-0000-000000000301@auth.lpqalfathmaulana.local'),
  ('a1fa7a10-0000-0000-0000-000000000302', 'AFMLOCAL-ANAK-C02', 'AFMLOCAL-ANAK-C02', 'santri+a1fa7a10-0000-0000-0000-000000000302@auth.lpqalfathmaulana.local'),
  ('a1fa7a10-0000-0000-0000-000000000303', 'AFMLOCAL-ANAK-C03', 'AFMLOCAL-ANAK-C03', 'santri+a1fa7a10-0000-0000-0000-000000000303@auth.lpqalfathmaulana.local')
