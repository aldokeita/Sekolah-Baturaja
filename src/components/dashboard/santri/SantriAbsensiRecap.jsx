...
const SantriAbsensiRecap = () => {
    ...
    const renderCalendar = () => {
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            let bgColor = "border-slate-200 bg-slate-50 text-slate-600 dark:border-white/10 dark:bg-slate-900/65 dark:text-slate-300";
            ...
            if (isPastOrToday) {
                ...
                if (!isActiveDay) {
                    bgColor = "border-slate-200 bg-slate-100 text-slate-600 dark:border-white/10 dark:bg-slate-900/65 dark:text-slate-300";
