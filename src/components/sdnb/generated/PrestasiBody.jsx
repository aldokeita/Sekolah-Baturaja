...
{(detilAda) && (<>
    <div onClick={tutup} style={{ position: "fixed", inset: "0", zIndex: "90", display: "flex", alignItems: "center", justifyContent: "center", padding: "28px", background: "rgba(16,19,45,.7)", backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)", animation: "fadeup .28s ease both" }}>
      <div onClick={stop} style={{ position: "relative", width: "min(760px,100%)", maxHeight: "86vh", overflow: "auto", borderRadius: "30px", background: "#20233f", border: "1px solid rgba(255,255,255,.16)", boxShadow: "0 54px 110px -34px rgba(10,14,50,.85)", animation: "rise .42s cubic-bezier(.2,.9,.25,1) both" }}>
        <div style={__dcs(detil.top)}>
          {detil.fotoUrl && (
            <img
              src={detil.fotoUrl}
              ...
              style={{ position: "absolute", inset: "0", zIndex: "0", width: "100%", height: "100%", objectFit: "cover", opacity: ".42" }}
            />
          )}
          <div style={{ position: "absolute", inset: "0", backgroundImage: "linear-gradient(rgba(255,255,255,.06) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.06) 1px,transparent 1px)", backgroundSize: "48px 48px" }}></div>
          ...
          <h3 style={{ position: "relative", margin: "16px 0 0", fontFamily: "'Plus Jakarta Sans','Archivo',system-ui,sans-serif", fontSize: "28px", lineHeight: "1.16", letterSpacing: "-.03em", fontWeight: "800", color: "#fff", textWrap: "pretty" }}>{detil.judul}</h3>
        </div>
