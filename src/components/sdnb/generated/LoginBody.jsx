 ...
 *
 * Verbatim markup of the Claude Design mockup, minus the public shell. LoginPage
 * mounts the shared public navbar; every visible form value still comes from the
 * mockup wiring below.
 *
...
<div className="th-root" style={{ position: "relative", minHeight: "100vh", overflow: "hidden" }}>
  ...
  {(belumMasuk) && (<>
  <div className="th-il login-stage" style={{ position: "relative", zIndex: "1", minHeight: "100vh", overflow: "hidden", display: "flex", flexDirection: "column", paddingTop: "96px", background: "#080b1e" }}>

    <div className="lsplit login-layout" style={{ position: "relative", zIndex: "2", flex: "1", maxWidth: "1240px", width: "100%", margin: "0 auto", padding: "10px 34px 46px", display: "grid", gridTemplateColumns: "1.05fr .95fr", gap: "48px", alignItems: "center" }}>

      <div className="login-card" style={{ position: "relative", padding: "38px 38px 34px", borderRadius: "32px", background: "rgba(255,255,255,.06)", backdropFilter: "blur(30px) saturate(190%)", WebkitBackdropFilter: "blur(30px) saturate(190%)", border: "1px solid rgba(255,255,255,.2)", boxShadow: "0 50px 110px -34px rgba(4,8,34,.98),inset 0 1px 0 rgba(255,255,255,.28)", animation: "fadeup .6s cubic-bezier(.22,.9,.28,1) both" }}>
        ...
        <div className="login-kicker" style={{ fontSize: "11.5px", fontWeight: "800", letterSpacing: ".18em", textTransform: "uppercase", color: "#9aa1e4" }}>Masuk portal</div>
        <h1 className="ltitle login-title" style={{ margin: "14px 0 0", fontFamily: "'Plus Jakarta Sans','Archivo',system-ui,sans-serif", fontSize: "42px", lineHeight: "1.02", letterSpacing: "-.042em", fontWeight: "800", color: "#fff" }}>Selamat datang<br />kembali.</h1>
        <p className="login-description" style={{ margin: "12px 0 0", fontSize: "14px", lineHeight: "1.65", color: "#9aa1e4" }}>Gunakan akun yang diberikan tata usaha. Belum punya akun? <a className="link login-link" href="/kontak">Hubungi sekolah</a>.</p>

        <div className="login-role-tabs" style={{ marginTop: "22px", display: "flex", gap: "8px", padding: "6px", borderRadius: "18px", background: "rgba(255,255,255,.06)", border: "1px solid rgba(255,255,255,.12)" }}>
          {(peran || []).map((p, $index) => (<React.Fragment key={$index}>
            <button type="button" className="rolebtn login-role-tab" aria-pressed={p.aktif} data-active={p.aktif ? "1" : "0"} onClick={p.pick} style={__dcs(p.style)}>{p.label}</button>
          </React.Fragment>))}
        </div>

        <div className="fld" style={{ marginTop: "20px" }}>
          <div className="login-field-label" style={{ marginBottom: "8px", fontSize: "12.5px", fontWeight: "700", color: "#c4c9f5" }}>{labelAkun}</div>
          <input className="login-input" onInput={setAkun} value={nilaiAkun} placeholder={contohAkun} />
        </div>
        ...
        <div className="fld" style={{ marginTop: "13px" }}>
          <div style={{ marginBottom: "8px", display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: "12px" }}>
            <span className="login-field-label" style={{ fontSize: "12.5px", fontWeight: "700", color: "#c4c9f5" }}>Kata sandi</span>
            <a className="link login-link" href="/kontak" style={{ fontSize: "12px" }}>Lupa sandi?</a>
          </div>
          <div style={{ position: "relative" }}>
            <input className="login-input" onInput={setSandi} value={nilaiSandi} type={tipeSandi} placeholder="Masukkan kata sandi" />
            <button type="button" className="eye login-password-toggle" onClick={toggleSandi} aria-label="Tampilkan kata sandi">
        ...
        <div className="login-meta" style={{ marginTop: "16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "14px", flexWrap: "wrap" }}>
          <button type="button" className="login-remember" onClick={toggleIngat} style={{ display: "inline-flex", alignItems: "center", gap: "10px", padding: "0", border: "0", background: "transparent", cursor: "pointer", fontFamily: "inherit" }}>
            <span className="login-remember-box" data-checked={ingat ? "1" : "0"} style={__dcs(kotakIngat)}>
            ...
            <span className="login-remember-label" style={{ fontSize: "13px", fontWeight: "600", color: "#c4c9f5" }}>Ingat perangkat ini</span>
          </button>
          <span className="login-status" style={{ fontSize: "12px", color: "#7e85bd" }}>{statusIsi}</span>
        </div>

        <button type="button" className="shine login-submit" onClick={masuk} style={__dcs(tombolMasuk)}>Masuk portal
        ...
        <div className="login-demo-section" data-empty={contoh?.length ? "0" : "1"} style={{ marginTop: "22px", paddingTop: "20px", borderTop: "1px solid rgba(255,255,255,.12)" }}>
          <div className="login-demo-title" style={{ fontSize: "11px", fontWeight: "800", letterSpacing: ".16em", textTransform: "uppercase", color: "#7e85bd" }}>Akun contoh untuk pratinjau</div>
      ...
      <div style={{ maxWidth: "1240px", margin: "0 auto", display: "flex", alignItems: "center", gap: "24px", padding: "12px 14px 12px 20px", borderRadius: "22px", background: "rgba(255,255,255,.62)", backdropFilter: "blur(26px) saturate(190%)", WebkitBackdropFilter: "blur(26px) saturate(190%)", border: "1px solid rgba(255,255,255,.9)", boxShadow: "0 20px 46px -20px rgba(55,65,120,.5),inset 0 1px 0 rgba(255,255,255,.95)" }}>
        <a href="/" style={{ display: "flex", alignItems: "center", gap: "12px", color: "inherit" }}>
          ...
          <div style={{ lineHeight: "1.15" }}>
            ...
            <div style={{ fontSize: "11px", fontWeight: "600", color: "#63678a" }}>Portal warga sekolah</div>
          </div>
        </a>
    ...
    <div className="kgrid" style={{ maxWidth: "1240px", margin: "0 auto", padding: "22px 28px 0", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "16px" }}>
      {(kartu || []).map((k, $index) => (<React.Fragment key={$index}>
        <div className="kpi" style={__dcs(k.box)}>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ fontSize: "10.5px", fontWeight: "800", letterSpacing: ".15em", textTransform: "uppercase", color: "#63678a" }}>{k.label}</div>
            <div style={{ marginTop: "14px", fontFamily: "'Plus Jakarta Sans','Archivo',system-ui,sans-serif", fontSize: "32px", lineHeight: "1.06", letterSpacing: "-.04em", fontWeight: "800", fontVariantNumeric: "tabular-nums", color: "#171827" }}>{k.nilai}<span style={{ marginLeft: "6px", fontSize: "16px", letterSpacing: "0", color: "#63678a" }}>{k.nilai2}</span></div>
            <div style={{ marginTop: "8px", fontSize: "12px", color: "#5f6389" }}>{k.ket}</div>
          </div>
        </div>
      </React.Fragment>))}
    </div>
    ...
    {(isTU) && (<>
      <div style={{ maxWidth: "1240px", margin: "0 auto", padding: "20px 28px 0" }}>
        ...
        <div className="panel" style={{ marginTop: "20px", padding: "22px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "18px", flexWrap: "wrap", borderTop: "3px solid var(--sekolah-aksen)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
            ...
            <div>
              ...
              <div style={{ marginTop: "4px", fontSize: "12.5px", color: "#5f6389" }}>{modulKet}</div>
            </div>
          </div>
        ...
        <div className="panel" style={{ marginTop: "14px", padding: "8px 0 10px" }}>
          <div className="thead" style={{ display: "grid", gridTemplateColumns: "56px 2fr 1fr 60px 1.3fr 1.1fr .9fr 80px", gap: "14px", padding: "14px 22px 12px", fontSize: "10.5px", fontWeight: "800", letterSpacing: ".13em", textTransform: "uppercase", color: "#63678a" }}>
          ...
          {(barisTU || []).map((b, $index) => (<React.Fragment key={$index}>
            <div className="trow" style={{ gridTemplateColumns: "56px 2fr 1fr 60px 1.3fr 1.1fr .9fr 80px" }}>
              <span className="mono" style={{ fontSize: "12.5px", fontWeight: "700", color: "#63678a" }}>{b.no}</span>
              <span style={{ display: "flex", alignItems: "center", gap: "12px", minWidth: "0" }}>
                ...
                <span style={{ minWidth: "0" }}>
                  ...
                  <span className="mono" style={{ display: "block", marginTop: "3px", fontSize: "11px", color: "#63678a" }}>{b.alias}</span>
                </span>
              </span>
          ...
          {(kosongTU) && (<>
            <div style={{ padding: "34px 22px", fontSize: "13.5px", color: "#5f6389" }}>Tidak ada murid yang cocok dengan pencarian.</div>
          </>)}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "14px", flexWrap: "wrap", padding: "16px 22px 8px", borderTop: "1px solid rgba(120,132,200,.16)" }}>
            <span style={{ fontSize: "12.5px", color: "#5f6389" }}>{jumlahTU}</span>
      ...
      <div style={{ maxWidth: "1240px", margin: "0 auto", padding: "22px 28px 0" }}>
        ...
        <div className="panel" style={{ marginTop: "18px", padding: "8px 0 10px" }}>
          <div style={{ padding: "20px 22px 14px" }}>
            ...
            <div style={{ marginTop: "5px", fontSize: "12.5px", color: "#5f6389" }}>{guru.sesi} &middot; klik lingkaran kehadiran untuk mengubah status</div>
          </div>
          <div className="thead" style={{ display: "grid", gridTemplateColumns: "56px 2fr 100px 1.7fr 1.5fr 84px", gap: "14px", padding: "0 22px 12px", fontSize: "10.5px", fontWeight: "800", letterSpacing: ".13em", textTransform: "uppercase", color: "#63678a" }}>
          ...
          {(guru.murid || []).map((m, $index) => (<React.Fragment key={$index}>
            <div className="trow" style={{ gridTemplateColumns: "56px 2fr 100px 1.7fr 1.5fr 84px" }}>
              <span className="mono" style={{ fontSize: "12.5px", fontWeight: "700", color: "#63678a" }}>{m.no}</span>
              <span style={{ display: "flex", alignItems: "center", gap: "12px", minWidth: "0" }}>
            ...
            <div style={{ marginTop: "16px", display: "flex", gap: "12px", flexWrap: "wrap" }}>
              {(wali.mini || []).map((m, $index) => (<React.Fragment key={$index}>
                <div style={{ minWidth: "120px", padding: "12px 16px", borderRadius: "16px", background: "rgba(255,255,255,.82)", border: "1px solid rgba(255,255,255,.95)" }}>
                  <div style={{ fontSize: "10px", fontWeight: "800", letterSpacing: ".14em", textTransform: "uppercase", color: "#63678a" }}>{m.k}</div>
                ...
                <div className="panel" style={{ display: "flex", alignItems: "center", gap: "18px", flexWrap: "wrap", padding: "20px 22px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
                    <div style={{ minWidth: "86px", padding: "10px 14px", borderRadius: "14px", background: "rgba(120,132,200,.12)" }}>
                      <div style={{ fontSize: "9.5px", fontWeight: "800", letterSpacing: ".13em", textTransform: "uppercase", color: "#63678a" }}>Rata-rata</div>
