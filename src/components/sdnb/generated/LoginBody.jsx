...
<div className="th-root" style={{ position: "relative", minHeight: "100vh", overflow: "hidden" }}>
  ...
  <div className="th-sky" aria-hidden="true" style={{ pointerEvents: "none", position: "absolute", inset: "-16%", zIndex: "0", background: "radial-gradient(42% 46% at 20% 24%,rgba(104,120,255,.6),rgba(104,120,255,0) 66%),radial-gradient(38% 44% at 80% 20%,rgba(233,137,196,.46),rgba(233,137,196,0) 66%),radial-gradient(48% 52% at 64% 86%,rgba(96,222,208,.4),rgba(96,222,208,0) 66%)", filter: "blur(30px)", animation: "floaty 28s ease-in-out infinite" }}></div>
  ...
  <div className="th-orb" aria-hidden="true" style={{ position: "fixed", top: "-170px", left: "-120px", width: "600px", height: "600px", borderRadius: "50%", zIndex: "0", background: "radial-gradient(circle at 38% 38%,rgba(150,170,255,.6),rgba(150,170,255,0) 68%)", filter: "blur(22px)", animation: "floaty 24s ease-in-out infinite" }}></div>
  <div className="th-orb" aria-hidden="true" style={{ position: "fixed", bottom: "-240px", right: "-6%", width: "660px", height: "660px", borderRadius: "50%", zIndex: "0", background: "radial-gradient(circle at 50% 50%,rgba(255,178,214,.48),rgba(255,178,214,0) 66%)", filter: "blur(24px)", animation: "floaty 30s ease-in-out infinite reverse" }}></div>
