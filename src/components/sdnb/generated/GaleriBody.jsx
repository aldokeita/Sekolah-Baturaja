...
<section style={{ position: "relative", minHeight: "82vh", display: "flex", alignItems: "center", overflow: "hidden", padding: "40px 0 20px" }}>
      <div aria-hidden="true" style={{ position: "absolute", inset: "0 -6%", zIndex: "0", overflow: "hidden", opacity: ".62", perspective: "1400px", WebkitMaskImage: "radial-gradient(120% 90% at 50% 45%,#000 30%,transparent 78%)", maskImage: "radial-gradient(120% 90% at 50% 45%,#000 30%,transparent 78%)" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: "10px", transform: "rotateX(14deg) rotateZ(-8deg) scale(1.04)", transformStyle: "preserve-3d" }}>
      ...
      <div style={{ position: "relative", zIndex: "1", maxWidth: "1240px", margin: "0 auto", padding: "0 28px", width: "100%" }}>
        ...
        <div style={{ marginTop: "34px", display: "flex", alignItems: "center", gap: "12px", color: "#6a6f95", fontSize: "12.5px", fontWeight: "600", letterSpacing: ".06em", textTransform: "uppercase" }}>
