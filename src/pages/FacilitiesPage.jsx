...
const F = [
  ...
  ['Perpustakaan', 'Penunjang', '96 m²', 'var(--sekolah-aksen-tengah),var(--sekolah-aksen-ujung)',
    ...
    [['Koleksi', '4.000 judul'], ['Kursi baca', '24 kursi'], ['Jam buka', '07.30–14.00'], ['Petugas', 'Petugas perpustakaan']], 2, 1],
  ['Ruang komputer', 'Penunjang', '64 m²', '#6ab8f0,#8fd8ec',
    ...
    [['Unit', '16 komputer'], ['Jaringan', '50 Mbps'], ['Pemakaian', '1 jam per kelas'], ['Pengampu', 'Guru pendamping']], 1, 1],
  ['Musala', 'Ibadah', '72 m²', '#5fb8a0,#8fe0c0',
    ...
    [['Kapasitas', '60 jamaah'], ['Tempat wudu', '12 keran'], ['Jadwal', 'Zuhur bergilir'], ['Pengampu', 'Guru pendamping']], 1, 1],
  ...
  ['Kebun sekolah', 'Lingkungan', '320 m²', '#7bbf6a,#b6e8a0',
    ...
    [['Petak', '9 petak kelas'], ['Tanaman', 'Kangkung, bayam'], ['Panen', '2 kali setahun'], ['Pendamping', 'Guru pendamping']], 1, 2],
  ['Ruang UKS', 'Kesehatan', '32 m²', '#f08a8a,#ffc9dc',
    ...
    [['Tempat tidur', '2 unit'], ['Petugas', 'Dokter kecil'], ['Pemeriksaan', 'Tiap semester'], ['Pengampu', 'Guru pendamping']], 1, 1],
