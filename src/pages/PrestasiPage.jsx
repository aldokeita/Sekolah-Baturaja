  ...
  const vals = {
    ...
    tingkatOpsi: TINGKAT.map((t) => {
      ...
      return {
        ...
        style: `position:relative;padding:10px 0 12px;border:0;background:transparent;cursor:pointer;font-family:inherit;font-size:13px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;transition:color .3s ease;color:${on ? 'var(--sdnb-teks-judul)' : 'var(--sdnb-teks-pendamping)'}`,
