...
- 56 ordered SQL migrations in `supabase/migrations/`. The directory name is historical — these are
...
supabase/migrations/              — 56 ordered SQL migrations (applied to local Postgres)
